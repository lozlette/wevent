...
### Project Brief
To create a front-end application using React.
...
Wevent is a web application that allows users to select a city and view events that are weather appropriate at that current time. For example, if the the current tempreture is over a certain amount of degrees, events of an'outdoorsy' nature will be generated.
